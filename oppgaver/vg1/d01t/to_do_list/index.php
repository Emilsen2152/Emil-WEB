        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="alert alert-warning">
                    Du er ikkje logga inn. Ta vare på lenka til denne lista for å kunna komma tilbake til ho seinare, eller logg inn for å få tilgang til delingsfunksjonar og for å sikra at du ikkje mistar lista.
                </div>
            </div>
        </div>
