    ...
    <div class="container-fluid bg-light py-2">
        <div class="container">
            <div class="mt-4 p-2 text-center">
                <h1>Yrkesfagleg fordjuping - Oppgåver</h1>
                <p>
                    Her finn du oppgåver relatert til faget Yrkesfagleg fordjuping.
                </p>
            </div>
        </div>
        ...
        <div class="container mt-4">
            ...
            $tasks = [
                [
                    "title" => "Avisa Hordaland for ungdommar",
                    "url" => "./avisa-hordaland/"
                ],
            ];
            ?>
