...
<body class="bg-dark">
    ...
    <div class="container-fluid bg-light py-5">
        ...
        <div class="container">
            <div class="mt-4 p-5 bg-warning text-dark rounded row">
                <div class="col-md-9">
                    <h2>Advarsel til PingPanik ansatte</h2>
                    <p>
                ...
                <div class="col-md-3">
                    <img src="assets/private/index/PP_Logo.png" class="rounded img-fluid mt-3" alt="PingPanik logoen.">
                </div>
            </div>
        </div>
    </div>
